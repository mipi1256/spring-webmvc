...
/**
      ...
      * - 데이터베이스에 저장할 데이터를 자바 클래스에 매칭
      ...
      create table tbl_score (
         stu_num INT(10) PRIMARY KEY AUTO_INCREMENT, -> 학번 int
         stu_name VARCHAR(255) NOT NULL, -> 학생 이름
         kor INT(3) NOT NULL, -> 국어 점수
         eng INT(3) NOT NULL, -> 영어 점수
         math INT(3) NOT NULL, -> 수학 점수
         total INT(3), -> 총점
         average FLOAT(5, 2), -> 평균
         grade CHAR(1) -> 학점
      );
   *
   */
