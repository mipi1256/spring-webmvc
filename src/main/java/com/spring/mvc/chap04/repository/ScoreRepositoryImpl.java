...
public class ScoreRepositoryImpl implements ScoreRepository{
   ...
   // Sping-Jdbc의 핵심 객체인 JdbcTemplate의 의존성 주입 (생성자 주입)
   ...
   public Score mapRow(ResultSet rs, int rowNum) throws SQLException {
      Score score = new Score(
            rs.getString("stu_name"), rs.getInt("kor"),
            rs.getInt("eng"), rs.getInt("math"),
            rs.getInt("stu_num"), rs.getInt("total"),
            rs.getDouble("average"), Grade.valueOf(rs.getString("grade"))
      );
      return score;
   }
